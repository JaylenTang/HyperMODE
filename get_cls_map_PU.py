...
def get_cls_map(net, all_data_loader, y, save_path, output_name='SSPredictions.png'):
    """Generate classification map. Used by PU, HC, LK, Houston2013."""
    ...
    classification_map(y_re, y, 300, save_path + output_name)
