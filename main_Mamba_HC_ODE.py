...
def loadData():
    if config.data == 'WHU-Hi-HC':
        data = sio.loadmat('./data/WHU-Hi-HC/WHU_Hi_HanChuan.mat')['WHU_Hi_HanChuan']
        labels = sio.loadmat('./data/WHU-Hi-HC/WHU_Hi_HanChuan_gt.mat')['WHU_Hi_HanChuan_gt']

    elif config.data == 'Houston2013':
        data = sio.loadmat('./data/Houston2013/Houston2013.mat')['houston2013']
        labels = sio.loadmat('./data/Houston2013/Houston2013_gt.mat')['houston2013_gt']
...
if __name__ == '__main__':
    ...
    for num in range(config.test_epoch):
        ...
        get_cls_map_PU.get_cls_map(net, all_data_loader, y, save_path, 'HC_SSPredictions.png')
